...
class ShowPagesDictbtList2 extends StatefulWidget {
  final String wordSearch;

  const ShowPagesDictbtList2({super.key, required this.wordSearch});

  @override
  State<ShowPagesDictbtList2> createState() => _ShowPagesDictbtList2State();
}

class _ShowPagesDictbtList2State extends State<ShowPagesDictbtList2> {
