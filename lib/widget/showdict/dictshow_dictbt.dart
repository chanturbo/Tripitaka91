...
import 'package:tripitaka91/widget/showdict/show_dictbt_list.dart';
import 'package:tripitaka91/widget/showdict/show_dictbt_list_2.dart';

class DictbtShowTitle extends StatefulWidget {
  const DictbtShowTitle({
    super.key,
  });

  @override
  State<DictbtShowTitle> createState() => _DictbtShowTitleState();
}

class _DictbtShowTitleState extends State<DictbtShowTitle> {
  String dictSarabun = '...';
        ...
        child: Column(
          children: <Widget>[
            ...
            Expanded(
              child: dictSarabun == '...'
                  ? loadFirst
                      ? ShowPagesDictbtList(wordSearch: dictSarabun)
                      : ShowPagesDictbtList2(wordSearch: dictSarabun)
                  : loadFirst
                      ? ShowPagesDictbtList(wordSearch: dictSarabun)
                      : ShowPagesDictbtList2(wordSearch: dictSarabun),

              // : FutureBuilder(
              //     future: _fetchDataDictbt(),
  ...
  // Future<List<String>?> _fetchDataDictbt() async {
