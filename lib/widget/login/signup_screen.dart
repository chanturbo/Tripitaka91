        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              const Expanded(
                child: Text(
                  'ข้าพเจ้ารับทราบว่าโหมดการอ่านออกเสียงหัวข้อธรรมและพระไตรปิฎกใช้โปรแกรมอัตโนมัติในการอ่าน ซึ่งอาจทำให้การอ่านออกเสียงไม่ถูกต้อง ครบถ้วน สมบูรณ์ โดยข้าพเจ้าจะใช้วิจารณญาณในการไตร่ตรองและตรวจสอบความถูกต้องของข้อมูลอีกครั้งหนึ่ง',
